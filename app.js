...
var photos = {
	...
	car: {
		caption: 'Red Alfa Romeo',
		url: 'images/car.jpg'
	},
	bride: {
		caption: 'Bride and Groom',
		url: 'images/bride-groom.webp'
	},
	coffee: {
		caption: 'Caffè latte',
...
function getFilterButton(target) {
	var button;
	if(target.classList.contains('bgg2-filter')) {
		button = target;
	} else if (target.parentNode.classList.contains('bgg2-filter')) {
